...
import 'package:lpg_qr/test/scanner_button_widgets.dart';
import 'package:lpg_qr/test/scanner_error_widget.dart';
...
class _BarcodeScannerWithOverlayState extends State<BarcodeScannerWithOverlay> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('LPG QR Code Scanner', style: TextStyle(color: Colors.white),),
